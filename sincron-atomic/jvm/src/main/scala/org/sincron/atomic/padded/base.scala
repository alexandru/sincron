...
package org.sincron.atomic.padded
...
import org.sincron.atomic
import org.sincron.atomic.{AtomicBuilder => BaseAtomicBuilder}
 ...
 * [[sincron.atomic.Atomic Atomic]] references.
 */
object Atomic {
  /**
...
/**
 * Provides a constructor for building cache-line padded
 * [[sincron.atomic.AtomicAny AtomicAny]] references.
 */
object AtomicAny {
...
/**
 * Provides a constructor for building cache-line padded
 * [[sincron.atomic.AtomicBoolean AtomicBoolean]] references.
 */
...
/**
 * Provides a constructor for building cache-line padded
 * [[sincron.atomic.AtomicByte AtomicByte]] references.
 */
object AtomicByte {
...
/**
 * Provides a constructor for building cache-line padded
 * [[sincron.atomic.AtomicChar AtomicChar]] references.
 */
object AtomicChar {
...
/**
 * Provides a constructor for building cache-line padded
 * [[sincron.atomic.AtomicDouble AtomicDouble]] references.
 */
object AtomicDouble {
...
/**
 * Provides a constructor for building cache-line padded
 * [[sincron.atomic.AtomicFloat AtomicFloat]] references.
 */
object AtomicFloat {
...
/**
 * Provides a constructor for building cache-line padded
 * [[sincron.atomic.AtomicInt AtomicInt]] references.
 */
object AtomicInt {
...
/**
 * Provides a constructor for building cache-line padded
 * [[sincron.atomic.AtomicLong AtomicLong]] references.
 */
object AtomicLong {
...
/**
 * Provides a constructor for building cache-line padded
 * [[sincron.atomic.AtomicNumberAny AtomicNumberAny]] references.
 */
...
/**
 * Provides a constructor for building cache-line padded
 * [[sincron.atomic.AtomicShort AtomicShort]] references.
 */
object AtomicShort {
